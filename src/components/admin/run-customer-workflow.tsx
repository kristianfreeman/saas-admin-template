  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        <DialogDescription>
          This will run a workflow for the customer. This is completely customizable and can be used to do whatever you want. Check out <code>src/workflows/customer.ts</code> to get started!
        </DialogDescription>
